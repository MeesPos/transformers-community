<template>
    <div class="text-center">
        ...
        <div class="grid w-[900px] mx-auto mt-8" :class="currentStep !== 1 && currentStep !== 4 ? 'grid-cols-3' : 'grid-cols-2'">
            <InertiaLink as="button" :href="route('onboarding.finish')" class="bg-brand-aqua font-bold font-montserrat text-lg w-[260px] py-3 rounded-md" v-if="currentStep !== 4" @click="finishTutorial">Uitleg overslaan</InertiaLink>
            ...
            <InertiaLink as="button" :href="route('onboarding.finish')" class="bg-brand-aqua font-bold font-montserrat text-lg w-[260px] py-3 rounded-md place-self-end" v-if="currentStep === 4">Uitleg afronden</InertiaLink>
